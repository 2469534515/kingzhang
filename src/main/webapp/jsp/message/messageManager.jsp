	...
	function toRemove(ids){
		...
		if(ids){
			...
			$app.confirm("删除数据不可恢复，确定要删除吗？",function(){
				 $.post('${path}/message/deleteMessageList.do?ids='+ids,function(data){
...
<body>
    ...
    <div class="rightinfo">
    	...
    	<table id="manTable" class="table_list" data-toggle="table"
			data-url="${path}/message/getMessageList.do" data-pagination="true"
			...
			<thead>
				<tr>
					...
					<th data-field="feedbackPeople">反馈人</th>
					<th data-field="feedbackContent">反馈内容</th>
					<th data-field="feedbackTime" data-formatter="dateFormatter">反馈时间</th>
